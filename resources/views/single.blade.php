            ...
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <div class="socials text-center">Share:
                        ...
                        <div class="addthis_inline_share_toolbox_0wji"></div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb" style="margin-left: -30px">
                        <img src="{{ asset($post->user->profile->avatar) }}" alt="Author" width="150" height="80" style="border-radius: 50%;">
                    </div>
                ...
                <div class="pagination-arrow">
                	...
                	@if($prev)
	                    ...
	                    <a href="{{ route('post.single', ['slug' => $prev->slug]) }}" class="btn-prev-wrap">
	                        ...
	                        <div class="btn-content">
	                            <div class="btn-content-title">Prevouis Post</div>
